...
def tiler_src_pad_buffer_probe(pad, info, u_data):
    ...
    while l_frame is not None:
        ...
        py_nvosd_text_params.display_text = " Frame Number={} Number of People={} Number of Cars={} Number of Buses={} Number of Trucks={} ".format(
            frame_number, obj_counter[PGIE_CLASS_ID_PERSON], obj_counter[PGIE_CLASS_ID_VEHICLE],
        ...
        print(" Frame Number={} Number of People={} Number of Cars={} Number of Buses={} Number of Trucks={} ".format(
                frame_number, obj_counter[PGIE_CLASS_ID_PERSON], obj_counter[PGIE_CLASS_ID_VEHICLE],
                obj_counter[PGIE_CLASS_ID_BUS], obj_counter[PGIE_CLASS_ID_TRUCK])) 
